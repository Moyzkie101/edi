...
<head>
   ...
   <style>
      ...
      ::-webkit-scrollbar-thumb {
         background: whitesmoke; /* Color of the scrollbar thumb */
         border-radius: 3px; /* Rounded corners for the thumb */
      }

         /* Style the scrollbar track when hovered */
      ::-webkit-scrollbar-thumb:hover {
         background: #ccc; /* Color of the scrollbar thumb when hovered */
      }
      .container {
         display: block;
      }
      ...
      /* Or if you want to be more specific to match the exact Clear button styling */
      #userTypeText, #statusText {
         font-size: 0.875rem;
         font-weight: 400;
      }
                        ...
                        <form action="" style="display: flex; align-items: center; gap: 10px;">
                           ...
                           <div class="dropdown">
                              <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 <span id="statusText" class="btn-text">Status</span>
                              </button>
                        ...
                        <?php if (!empty($users)): ?>
                           <?php foreach ($users as $index => $user): ?>
                              <tr data-user-id="<?php echo htmlspecialchars($user['id_number'] ?? ''); ?>"
                                 ...
                                 <td>
                                    <span class="<?php echo ($user['status'] ?? '') === 'Active' ? 'text-success' : 'text-danger'; ?> btn-text">
