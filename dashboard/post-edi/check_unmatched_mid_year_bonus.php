<?php
     ...
     */
    function fetchUnmatchedMYB($conn, $database, string $mainzone, string $restrictedDate): array
    {
        $sql = "SELECT
...
<body>
    ...
    <center><h2>MID YEAR BONUS <span>[UNMATCHED BRANCH CHECK]</span></h2></center>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['generate'])) {
        ...
        if ($mainzone === '' || $restrictedDate === '') {
            ...
            $result = fetchUnmatchedMYB($conn, $database, $mainzone, $restrictedDate);
