<?php
     ...
     */
    function fetchUnmatched13th($conn, $database, string $mainzone, string $restrictedDate): array
    {
        $sql = "SELECT
...
<body>
    ...
    <center><h2>13TH MONTH <span>[UNMATCHED BRANCH CHECK]</span></h2></center>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['generate'])) {
        ...
        if ($mainzone === '' || $restrictedDate === '') {
            ...
            $result = fetchUnmatched13th($conn, $database, $mainzone, $restrictedDate);
