<?php
    ...
    if (isset($_GET['proceed']) && $_GET['proceed'] === 'true') {
        ...
        header('Location: post-edi_remittance-old.php');
        exit();
    }
    ...
    function postEdi() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'post-edi_remittance-old.php?proceed=true';
            } else {
                window.location.href = 'post-edi_remittance-old.php';
            }
        });
    }
</script>
...
$result = mysqli_query($conn, $sql);
     ...
     if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td style='background-color: $color; font-weight: $bold; text-align: right'>" . htmlspecialchars($row['dr1']) . "</td>";
            echo "<td style='background-color: $color; font-weight: $bold; text-align: right'>" . htmlspecialchars($row['dr2']) . "</td>";
            echo "<td style='background-color: $color; font-weight: $bold; text-align: right'>" . htmlspecialchars($row['dr3']) . "</td>";
            echo "<td style='background-color: $color; font-weight: $bold; text-align: right'>" . htmlspecialchars($row['dr4']) . "</td>";
