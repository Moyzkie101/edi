<?php
    ...
    if (isset($_GET['proceed']) && $_GET['proceed'] === 'true') {
        ...
        header('Location: post-edi_13th-month.php');
        exit();
    }
    ...
    function postEdi() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'post-edi_13th-month.php?proceed=true';
            } else {
                window.location.href = 'post-edi_13th-month.php';
            }
        });
    }
</script>
        ...
        $result = mysqli_query($conn, $sql);
         ...
         if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['basic_pay_regular'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['basic_pay_trainee'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['allowances'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['bm_allowance'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['overtime_regular'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['overtime_trainee'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['cola'], 2)) . "</td>"; 
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['excess_pb'], 2)) . "</td>"; 
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['other_income'], 2)) . "</td>"; 
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['salary_adjustment'], 2)) . "</td>"; 
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['graveyard'], 2)) . "</td>";
                // convert to negative if positive value 
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['late_regular'] > 0 ? -$row['late_regular'] : $row['late_regular'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['late_trainee'] > 0 ? -$row['late_trainee'] : $row['late_trainee'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['leave_regular'] > 0 ? -$row['leave_regular'] : $row['leave_regular'], 2)) . "</td>";
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['leave_trainee'] > 0 ? -$row['leave_trainee'] : $row['leave_trainee'], 2)) . "</td>";

                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'> ".htmlspecialchars(number_format($total, 2))." </td>"; 
                ...
                echo "<td class='amount-cell' style='background-color: $color; font-weight: $bold'>" . htmlspecialchars(number_format($row['all_other_deductions'], 2)) . "</td>"; 
