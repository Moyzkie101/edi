    ...
    if(isset($_POST['download'])) {
        ...
        if(mysqli_num_rows($dlresult) > 0) {
            ...
            $headerRow1 = [
                ...
                'Overtime Regular', 'Overtime Trainee', 'COLA', 'Sick Leave', 'Other Income', 'Salary Adjustment', 'Graveyard', 'Late Regular',
            ...
            $headerRow3 = [
                ...
                $gl_code_cola, $gl_code_sick_leave, $gl_code_other_income, $gl_code_salary_adjustment, $gl_code_graveyard, $gl_code_late_regular, $gl_code_late_trainee,
            ...
            while($row = mysqli_fetch_assoc($dlresult)) {
                ...
                $sheet->setCellValueExplicit('J' . $rowIndex, $row['sick_leave'], \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
...
<body>
    ...
    <center><h2>Sick Leave Conversion Report <span>[HRMD-Format]</span></h2></center>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['generate'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['basic_pay_regular'],2)) . "</td>";
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['basic_pay_trainee'],2)) . "</td>";
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['allowances'],2)) . "</td>";
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['bm_allowance'],2)) . "</td>";
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['overtime_regular'],2)) . "</td>";
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['overtime_trainee'],2)) . "</td>";
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['cola'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['sick_leave'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['other_income'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['salary_adjustment'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['graveyard'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['late_regular'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['late_trainee'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['leave_regular'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['leave_trainee'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['all_other_deductions'],2)) . "</td>"; 
                echo "<td style='text-align: right'>" . htmlspecialchars(number_format($row['total'],2)) . "</td>"; 
