<?php
    ...
    if (isset($_GET['proceed']) && $_GET['proceed'] === 'true') {
        ...
        header('Location: post-edi_payroll.php');
        exit();
    }
        ...
        if ($result->num_rows > 0) {
            ...
            if (empty($errors)) {
                ...
                if ($zone === 'LNCR Showroom' || $zone === 'VISMIN Showroom') {
                    ...
                    $updatePost = "UPDATE edi.payroll p
                                    INNER JOIN 
                                        " . $database[1] . ".branch_profile bp
                                    ON 
                                        p.bos_code = bp.code AND p.region_code = bp.region_code  
...
<body>
    ...
    <center><h2>PAYROLL <span>[POST EDI]</span></center>
    ...
    function postEdi() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'post-edi_payroll.php?proceed=true';
            } else {
                window.location.href = 'post-edi_payroll.php';
            }
        });
    }
</script>
