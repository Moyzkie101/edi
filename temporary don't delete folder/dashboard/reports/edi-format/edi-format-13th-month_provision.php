    ...
    if (isset($_POST['download'])) {
        ...
        if($mainzone === 'ALL' || $zone === 'ALL') {
            if(mysqli_num_rows($dlresult) > 0) {
                ...
                $groups = [
                    'EDI_13th_Month_Provision_Report_LZN_' => [],
                    'EDI_13th_Month_Provision_Report_NCR_' => [],
                    'EDI_13th_Month_Provision_Report_VIS_' => [],
                    'EDI_13th_Month_Provision_Report_MIN_' => [],
                    'EDI_13th_Month_Provision_Report_NATIONWIDE-SHOWROOM_' => [],
                ];
                ...
                foreach ($groups as $groupName => $rows) {
                    ...
                    // Header rows
                    $headerRow1 = [
                        '13th Month Provision for Bonus', '', '', '', '',
                    ];
                    $headerRow2 = [
                ...
                $zipFilename = 'EDI_13th_Month_Provision_Report_' . $restrictedDate . '.zip';
            ...
            if (mysqli_num_rows($dlresult) > 0) {
                ...
                if($status==='Active'){
                    if($zone === 'LNCR Showroom' || $zone === 'VISMIN Showroom'){
                        $filename = "EDI_13th_Month_Provision_Report_" . $mainzone . "_" . $region . "_" . $restrictedDate . ".xls";
                    }else{
                        $filename = "EDI_13th_Month_Provision_Report_" . $zone . "_" . $region . "_" . $restrictedDate . ".xls";
                    }
                    
                }else{
                    if($zone === 'LNCR Showroom' || $zone === 'VISMIN Showroom'){
                        $filename = "EDI_13th_Month_Provision_Report_" . $mainzone . "_" . $region . "_" . $restrictedDate . "(Inactive or Pending).xls";
                    }else{
                        $filename = "EDI_13th_Month_Provision_Report_" . $zone . "_" . $region . "_" . $restrictedDate . "(Inactive or Pending).xls";
                    }
                }
...
<body>
    ...
    <script src="../../../assets/js/admin/provision-report/edi-format/script.js"></script>
    <script>
