...
<body>
    ...
    <center><h2>Payroll Report <span style="font-size: 22px; color: red;">[EDI-Format]</span></h2></center>
    ...
    <script src="../../../assets/js/admin/report-file/edi-format/script1.js"></script>
    <script>
