        ...
        // }
            ...
            if($mainzone === 'ALL' || $zone === 'ALL'){
                if(mysqli_num_rows($dlresult) > 0) {
                    ...
                    $groups = [
                        'EDI_Allocation_Payroll_Report_LZN_' => [],
                        'EDI_Allocation_Payroll_Report_NCR_' => [],
                        'EDI_Allocation_Payroll_Report_VIS_' => [],
                        'EDI_Allocation_Payroll_Report_MIN_' => [],
                        'EDI_Allocation_Payroll_Report_NATIONWIDE-SHOWROOM_' => []
                    ];
                    ...
                    // 3. Create ZIP
                    $zipPath = $tmpDir . '/EDI_Allocation_Payroll_Report_' . $restrictedDate . '.zip';
                    $zip = new ZipArchive();
                ...
                if(mysqli_num_rows($dlresult) > 0) {
                    ...
                    if($zone === 'LNCR Showroom' || $zone === 'VISMIN Showroom'){
                        if(!empty($region)){
                            $filename = "EDI_Allocation_Payroll_Report_" . $mainzone . "_" . $region . "_" . $restrictedDate . ".xls";
                        }else{
                            $filename = "EDI_Allocation_Payroll_Report_" . $mainzone . "_" . $restrictedDate . ".xls";
                        }
                    }else{
                        if(!empty($region)){
                            $filename = "EDI_Allocation_Payroll_Report_" . $zone .  "_" . $region . "_" . $restrictedDate . ".xls";
                        } else {
                            $filename = "EDI_Allocation_Payroll_Report_" . $zone . "_" . $restrictedDate . ".xls";
                        }
                    }
...
<body>
    ...
    <center><h2>Payroll Allocation Report <span style="font-size: 22px; color: red;">[EDI-Format]</span></h2></center>
