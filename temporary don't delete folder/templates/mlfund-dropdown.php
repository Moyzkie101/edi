...
<!-- <li class="dropdown">
    ...
    <div class="dropdown-content">
        <a id="user" href="#">Branch Master File</a> -->
        <!--<a id="user" href="#">Region Profile</a>-->
        <!--<a id="user" href="#">Region Area Branch</a>-->
    <!-- </div>
</li> -->
...
<li class="dropdown">
    ...
    <div class="dropdown-content">
        ...
        <a id="user" href="#">Mid Year Bonus Payroll</a>
        <a id="user" href="#">Sick Leave</a>
    </div>
</li>
...
<li class="dropdown">
    ...
    <div class="dropdown-content">
        ...
        <!--<div class="dropdown-group">
            ...
            <div class="group-content">
                <a id="user" href="cad-report-payroll.php">Payroll</a>
                <a id="user" href="#">Provision</a>
                <a id="user" href="#">Remitance OLD</a>
                <a id="user" href="#">Remitance NEW</a>
                <a id="user" href="#">Mid Year Bonus</a> 
                <a id="user" href="cad-report-operation-deduction.php">Operation Deduction</a>
            </div>
        </div>-->
        <div class="dropdown-group">
        ...
        <!--<div class="dropdown-group">
            <button class="group-btn">RECON Format</button>
            <div class="group-content">
                <a id="user" href="recon-report-mcash.php">MCash Wallet</a>
                <div class="dropdown-group">
                    <button class="group-btn">Remittances</button>
                    <div class="group-content">
                        <a id="user" href="#">Payroll</a>
                        <a id="user" href="#">Remitance OLD</a>
                        <a id="user" href="#">Remitance NEW</a>
        ...
        <div class="dropdown-group">
            ...
            <div class="group-content">
                <a id="user" href="report_payroll_mlfund.php">ML Fund</a>
