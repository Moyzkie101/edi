...
if (isset($_POST['upload'])) {
        ...
        if (move_uploaded_file($filePath, $destination)) {
            ...
            echo "<script>alert('File upload failed.'); window.location.href='import_sick-leave.php';</script>";
            exit;
    ...
    if (empty($messages)) {
        ...
        echo "<script>
                if (confirm('File is ready to upload. Do you want to continue?')) {
                    window.location.href = 'import_sick-leave.php?proceed=true';
                } else {
                    window.location.href = 'import_sick-leave.php';
                }
            </script>";
...
if (isset($_GET['proceed']) && $_GET['proceed'] === 'true') {
    ...
    if ($insertSuccess) {
        echo "<script>alert('Data successfully loaded.'); window.location.href='import_sick-leave.php';</script>";
    } else {
        echo "<script>alert('Failed to upload.'); window.location.href='import_sick-leave.php';</script>";
    }
}
    ...
    foreach ($regionCodesToDelete as $regionCode) {
        ...
        if ($row_resultPost['post_edi'] === 'pending') {
            ...
            if ($insertSuccess) {
                ...
                echo "<script>alert('Insertion Failed.'); window.location.href='import_sick-leave.php';</script>";
            }
            ...
            echo "<script>alert('Opps! Unable to Override. Data Already Posted.'); window.location.href='import_sick-leave.php';</script>";
        }
    }
