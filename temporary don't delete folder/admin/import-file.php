...
<body>
    ...
    <center><h2>PAYROLL <span>[IMPORT]</span></h2></center>
    ...
    if (empty($messages)) {
        ...
        echo "<script>
                if (confirm('File is ready to upload. Do you want to continue?')) {
                    window.location.href = 'import-file.php?proceed=true';
                } else {
                    window.location.href = 'import-file.php';
                }
            </script>";
...
if (isset($_GET['proceed']) && $_GET['proceed'] === 'true') {
    ...
    if ($insertSuccess) {
        echo "<script>alert('Data successfully loaded.'); window.location.href='import-file.php';</script>";
    } else {
        echo "<script>alert('Failed to upload.'); window.location.href='import-file.php';</script>";
    }
}
    ...
    foreach ($regionCodesToDelete as $regionCode) {
        ...
        if ($row_resultPost['post_edi'] === 'pending') {
            ...
            if ($insertSuccess) {
                ...
                echo "<script>alert('Insertion Failed.'); window.location.href='import-file.php';</script>";
            }
            ...
            echo "<script>alert('Opps! Unable to Override. Data Already Posted.'); window.location.href='import-file.php';</script>";
        }
    }
