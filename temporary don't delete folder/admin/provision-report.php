...
<body>
    ...
    <center><h2>Provision Report <span style="font-size: 22px; color: red;">[EDI-Format]</span></h2></center>

    <div class="import-file">
        
        <form action="provision-report.php" method="post">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['proceed'])) {
    ...
    // } 
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // first row
            echo "<tr>";
            echo "<th colspan='6'>Payroll Date : ".$restrictedDate."</th>";
            echo "</tr>";
