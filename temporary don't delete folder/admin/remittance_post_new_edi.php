<?php
    ...
    if (isset($_GET['proceed']) && $_GET['proceed'] === 'true') {
        ...
        header('Location: remittance_post_new_edi.php');
        exit();
    }
    ...
    function postEdi() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = 'remittance_post_new_edi.php?proceed=true';
            } else {
                window.location.href = 'remittance_post_new_edi.php';
            }
        });
    }
</script>
